// Objetivo: memorizar (cache) el resultado de ejecutar una función costosa, para evitar
// que se vuelva a llamar al método
// controlar si el beneficio de memorizarlo es superior al de recalcularlo

import { useMemo, useState } from "react";

// Ejemplo: 
// Tenemos una lista de compras y ya calculaste el costo total de hacer toda
// la compra
// Si no agregamos nada ni tampoco cambia nada, cúal es el costo total?
...
export const ShoppingCart = () => {
    ...
    const finalCost = useMemo(() => totalCost - discount, [discount, totalCost]);
